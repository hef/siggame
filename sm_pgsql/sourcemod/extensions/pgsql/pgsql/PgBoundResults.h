...
#ifndef _INCLUDE_SM_PGSQL_BOUND_RESULTS_H_
#define _INCLUDE_SM_PGSQL_BOUND_RESULTS_H_
...
public:
	//@TODO: Fix Me
	PgBoundResults(/*MYSQL_STMT *stmt, MYSQL_RES *res*/);
	~PgBoundResults();
public: //IResultSet
...
#endif //_INCLUDE_SM_PGSQL_BOUND_RESULTS_H_
